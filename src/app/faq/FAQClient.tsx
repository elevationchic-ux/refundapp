      ...
      <div className="max-w-4xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Tout ce que vous devez savoir sur les remboursements, litiges et démarches légales en France.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-indigo-100 mb-6">Déposez votre dossier et nos agents vous répondent sous 24 h.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/claim/new" className="bg-white hover:bg-gray-100 text-indigo-600 px-6 py-3 rounded-lg font-semibold transition-colors inline-flex items-center justify-center gap-2">
              Déposer mon dossier <ArrowRight className="w-4 h-4" />
            </Link>
            <Link href="/resources" className="bg-indigo-800 hover:bg-indigo-900 text-white px-6 py-3 rounded-lg font-semibold transition-colors">
              Voir les ressources
            </Link>
          </div>
        </motion.div>
